...
func ProductionMenuCatalog() []domain.Menu {
	return []domain.Menu{
		...
		{ID: "menu-operations-tasks", ParentID: "menu-system-config", Name: "定时任务", Path: "/system/tasks", Type: domain.MenuTypeMenu, Component: "/system/tasks/index.vue", Icon: "lucide:clock-3", Permission: "ops:tasks:read", Sort: 40, Visible: true, Active: true},
