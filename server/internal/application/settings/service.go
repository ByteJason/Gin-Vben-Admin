...
func DefaultDefinitions() map[string]Definition {
	definitions := map[string]Definition{
		...
		"security.access_ttl":               {Key: "security.access_ttl", Category: CategorySecurity, Kind: KindString, Default: `"24h"`, Description: "登录态有效期", RestartRequired: true, EnvKey: "AUTH_ACCESS_TTL", YAMLPath: "auth.access_ttl"},
		...
		"captcha.type":                      {Key: "captcha.type", Category: CategoryCaptcha, Kind: KindString, Default: `"image"`, Allowed: []string{"image", "slider", "cloudflare"}, Description: "验证码类型", EnvKey: "AUTH_CAPTCHA_TYPE", YAMLPath: "auth.captcha_type"},
		"captcha.length":                    {Key: "captcha.length", Category: CategoryCaptcha, Kind: KindNumber, Default: `6`, Description: "图片验证码长度", EnvKey: "AUTH_CAPTCHA_LENGTH", YAMLPath: "auth.captcha_length"},
		"captcha.charset":                   {Key: "captcha.charset", Category: CategoryCaptcha, Kind: KindString, Default: `"alphanumeric"`, Allowed: []string{"numeric", "alpha", "alphanumeric"}, Description: "图片验证码字符集", EnvKey: "AUTH_CAPTCHA_CHARSET", YAMLPath: "auth.captcha_charset"},
		"captcha.width":                     {Key: "captcha.width", Category: CategoryCaptcha, Kind: KindNumber, Default: `240`, Description: "图片验证码宽度", EnvKey: "AUTH_CAPTCHA_WIDTH", YAMLPath: "auth.captcha_width"},
		"captcha.height":                    {Key: "captcha.height", Category: CategoryCaptcha, Kind: KindNumber, Default: `80`, Description: "图片验证码高度", EnvKey: "AUTH_CAPTCHA_HEIGHT", YAMLPath: "auth.captcha_height"},
		"captcha.failure_limit":             {Key: "captcha.failure_limit", Category: CategoryCaptcha, Kind: KindNumber, Default: `0`, Description: "错误次数限制，0 表示不限制", EnvKey: "AUTH_CAPTCHA_FAILURE_LIMIT", YAMLPath: "auth.captcha_failure_limit"},
		"captcha.cloudflare.site_key":       {Key: "captcha.cloudflare.site_key", Category: CategoryCaptcha, Kind: KindString, Default: `""`, Description: "Cloudflare Turnstile 站点密钥", EnvKey: "AUTH_CAPTCHA_CLOUDFLARE_SITE_KEY", YAMLPath: "auth.captcha_cloudflare_site_key"},
		"captcha.cloudflare.secret_key":     {Key: "captcha.cloudflare.secret_key", Category: CategoryCaptcha, Kind: KindSecret, Sensitive: true, Default: `""`, Description: "Cloudflare Turnstile 私密密钥", EnvKey: "AUTH_CAPTCHA_CLOUDFLARE_SECRET_KEY", YAMLPath: "auth.captcha_cloudflare_secret_key"},
...
func displayNameForKey(key string) string {
	if name, ok := map[string]string{
		...
		"captcha.key_prefix": "验证码键前缀", "captcha.type": "验证码类型", "captcha.length": "验证码长度", "captcha.charset": "验证码字符集", "captcha.width": "验证码宽度", "captcha.height": "验证码高度", "captcha.failure_limit": "错误次数限制", "captcha.cloudflare.site_key": "Cloudflare 站点密钥", "captcha.cloudflare.secret_key": "Cloudflare 私密密钥", "i18n.mode": "语言模式",
