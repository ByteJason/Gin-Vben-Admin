...
type SMTPAccount struct {
	...
	DeletedAt          *time.Time   `gorm:"column:deleted_at;precision:6;index:idx_smtp_accounts_scope,priority:3;index:idx_smtp_accounts_enabled,priority:3;comment:删除时间"`
}
...
type EmailMessage struct {
	...
	CreatedAt         time.Time   `gorm:"column:created_at;precision:6;not null;index:idx_email_messages_scope,priority:3;index:idx_email_messages_status,priority:3;comment:创建时间"`
	UpdatedAt         time.Time   `gorm:"column:updated_at;precision:6;not null;comment:更新时间"`
