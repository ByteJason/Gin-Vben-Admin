...
var relations = []Relation{
	...
	{From: "file_objects", To: "media_categories", Kind: RelationBelongsTo, Keys: "file_objects.category_id -> media_categories.id", TenantKey: "tenant_id", Description: "文件媒体分类"},
	{From: "media_usages", To: "file_objects", Kind: RelationBelongsTo, Keys: "media_usages.resource_id -> file_objects.id", TenantKey: "tenant_id", Description: "媒体引用资源"},
	...
	{From: "notification_caller_accounts", To: "notification_callers", Kind: RelationBelongsTo, Keys: "notification_caller_accounts.caller_id -> notification_callers.id", TenantKey: "tenant_id", Description: "通知调用者绑定"},
	{From: "notification_caller_accounts", To: "smtp_accounts", Kind: RelationBelongsTo, Keys: "notification_caller_accounts.smtp_account_id -> smtp_accounts.id", TenantKey: "tenant_id", Description: "通知绑定SMTP账户"},
	{From: "notification_template_locales", To: "notification_templates", Kind: RelationBelongsTo, Keys: "notification_template_locales.template_id -> notification_templates.id", TenantKey: "tenant_id", Description: "模板语言版本"},
	{From: "notification_template_versions", To: "notification_templates", Kind: RelationBelongsTo, Keys: "notification_template_versions.template_id -> notification_templates.id", TenantKey: "tenant_id", Description: "模板发布快照"},
	{From: "verification_policies", To: "notification_callers", Kind: RelationBelongsTo, Keys: "verification_policies.caller_id -> notification_callers.id", TenantKey: "tenant_id", Description: "验证码调用者策略"},
	{From: "verification_challenges", To: "notification_callers", Kind: RelationBelongsTo, Keys: "verification_challenges.caller_id -> notification_callers.id", TenantKey: "tenant_id", Description: "验证码调用者挑战"},
	{From: "verification_challenges", To: "email_messages", Kind: RelationBelongsTo, Keys: "verification_challenges.message_id -> email_messages.id", TenantKey: "tenant_id", Description: "验证码邮件消息"},
