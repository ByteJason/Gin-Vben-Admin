...
type MediaCategory = persistencemodel.MediaCategory
type MediaUsage = persistencemodel.MediaUsage
...
type NotificationCaller = persistencemodel.NotificationCaller
type NotificationCallerAccount = persistencemodel.NotificationCallerAccount
type NotificationTemplate = persistencemodel.NotificationTemplate
type NotificationTemplateLocale = persistencemodel.NotificationTemplateLocale
type NotificationTemplateVersion = persistencemodel.NotificationTemplateVersion
type VerificationPolicy = persistencemodel.VerificationPolicy
type VerificationChallenge = persistencemodel.VerificationChallenge
